...
const ALL_CATEGORIES: CategoryData[] = [
  ...
  },
  {
    ...
    items: [
      { id: "ht-1", name: "Heart Health Package", type: "package", includedTests: [{ name: "Lipid Profile", description: "Cholesterol and triglycerides" }, { name: "hs-CRP", description: "Inflammation marker" }, { name: "Homocysteine", description: "Heart risk marker" }, { name: "Troponin I", description: "Heart muscle damage" }, { name: "BNP", description: "Heart failure marker" }, { name: "CBC", description: "Blood count" }], includedTestCount: 6, basePrice: 2499, discountedPrice: 999, badges: ["10-Hour Report Guarantee"] },
      { id: "ht-2", name: "Lipid Profile", type: "single", includedTests: [{ name: "Lipid Profile", description: "Total cholesterol, HDL, LDL, triglycerides" }], includedTestCount: 1, basePrice: 800, discountedPrice: 299 },
      { id: "ht-3", name: "Cardiac Risk Markers", type: "package", includedTests: [{ name: "hs-CRP", description: "High-sensitivity C-reactive protein" }, { name: "Homocysteine", description: "Amino acid linked to heart risk" }, { name: "Lipid Profile", description: "Cholesterol panel" }], includedTestCount: 3, basePrice: 1499, discountedPrice: 599 },
      { id: "ht-4", name: "Complete Heart Panel", type: "package", includedTests: [{ name: "Lipid Profile", description: "Cholesterol" }, { name: "hs-CRP", description: "Inflammation" }, { name: "Troponin I", description: "Heart damage" }, { name: "BNP", description: "Heart failure" }, { name: "CK-MB", description: "Cardiac enzyme" }, { name: "Homocysteine", description: "Risk marker" }, { name: "CBC", description: "Blood count" }, { name: "HbA1c", description: "Blood sugar" }], includedTestCount: 8, basePrice: 3499, discountedPrice: 1399, promotionalText: "Buy 2, Get EXTRA OFF!" },
    ],
  },
  {
    id: "blood",
    ...
    items: [
      { id: "bl-1", name: "Complete Blood Count", type: "single", includedTests: [{ name: "CBC", description: "Red blood cells, white blood cells, haemoglobin, platelets" }], includedTestCount: 1, basePrice: 600, discountedPrice: 199, badges: ["10-Hour Report Guarantee"] },
      { id: "bl-2", name: "Blood Studies Panel", type: "package", includedTests: [{ name: "CBC", description: "Complete blood count" }, { name: "ESR", description: "Inflammation marker" }, { name: "Blood Grouping", description: "ABO and Rh" }, { name: "Peripheral Smear", description: "Blood cell morphology" }, { name: "Iron Studies", description: "Iron status" }], includedTestCount: 5, basePrice: 1599, discountedPrice: 599 },
      { id: "bl-3", name: "ESR Test", type: "single", includedTests: [{ name: "ESR", description: "Erythrocyte sedimentation rate" }], includedTestCount: 1, basePrice: 400, discountedPrice: 149 },
      { id: "bl-4", name: "Blood Iron Panel", type: "package", includedTests: [{ name: "CBC", description: "Blood count" }, { name: "Iron Studies", description: "Iron, ferritin, TIBC" }, { name: "Reticulocyte Count", description: "New red blood cell production" }], includedTestCount: 3, basePrice: 1299, discountedPrice: 499 },
    ],
  },
  {
    id: "vitamin",
  ...
  },
  {
    ...
    items: [
      { id: "ty-1", name: "Thyroid Profile (T3 T4 TSH)", type: "single", includedTests: [{ name: "T3", description: "Triiodothyronine" }, { name: "T4", description: "Thyroxine" }, { name: "TSH", description: "Thyroid stimulating hormone" }], includedTestCount: 3, basePrice: 999, discountedPrice: 399, badges: ["10-Hour Report Guarantee"] },
      { id: "ty-2", name: "Thyroid Comprehensive Panel", type: "package", includedTests: [{ name: "TSH", description: "Thyroid stimulating hormone" }, { name: "Free T3", description: "Active thyroid hormone" }, { name: "Free T4", description: "Thyroid hormone" }, { name: "Anti-TPO", description: "Thyroid antibodies" }, { name: "Thyroglobulin", description: "Thyroid protein" }], includedTestCount: 5, basePrice: 1999, discountedPrice: 799 },
      { id: "ty-3", name: "TSH Test", type: "single", includedTests: [{ name: "TSH", description: "Thyroid stimulating hormone" }], includedTestCount: 1, basePrice: 500, discountedPrice: 199 },
      { id: "ty-4", name: "Thyroid Plus Vitamin", type: "package", includedTests: [{ name: "TSH", description: "Thyroid hormone" }, { name: "Free T3", description: "Active thyroid" }, { name: "Free T4", description: "Thyroid hormone" }, { name: "Vitamin D", description: "Vitamin D" }, { name: "Vitamin B12", description: "B12" }], includedTestCount: 5, basePrice: 2499, discountedPrice: 999 },
    ],
  },
  {
    id: "kidney",
  ...
  },
  {
    ...
    items: [
      { id: "wh-1", name: "Women's Wellness Panel", type: "package", includedTests: [{ name: "CBC", description: "Blood count" }, { name: "Thyroid Profile", description: "Thyroid" }, { name: "Iron Studies", description: "Iron" }, { name: "Vitamin D", description: "Vitamin" }, { name: "Blood Glucose", description: "Sugar" }, { name: "Calcium", description: "Bone health" }, { name: "Lipid Profile", description: "Heart" }], includedTestCount: 7, basePrice: 2499, discountedPrice: 999, badges: ["BEST PRICE EVER!"] },
      { id: "wh-2", name: "Iron Deficiency Panel", type: "package", includedTests: [{ name: "CBC", description: "Blood count" }, { name: "Iron Studies", description: "Iron status" }, { name: "Ferritin", description: "Iron stores" }, { name: "Vitamin B12", description: "B12" }], includedTestCount: 4, basePrice: 1499, discountedPrice: 599 },
      { id: "wh-3", name: "Thyroid for Women", type: "single", includedTests: [{ name: "TSH", description: "Thyroid stimulating hormone" }], includedTestCount: 1, basePrice: 500, discountedPrice: 199 },
    ],
  },
  {
    id: "senior-citizen",
    ...
    items: [
      { id: "sc-1", name: "Senior Citizen Comprehensive", type: "package", includedTests: [{ name: "CBC", description: "Blood count" }, { name: "Lipid Profile", description: "Heart" }, { name: "KFT", description: "Kidney" }, { name: "LFT", description: "Liver" }, { name: "Thyroid Profile", description: "Thyroid" }, { name: "HbA1c", description: "Diabetes" }, { name: "Vitamin D", description: "Bone health" }, { name: "Vitamin B12", description: "Nerve function" }, { name: "PSA", description: "Prostate" }, { name: "Urine Routine", description: "Urinalysis" }], includedTestCount: 10, basePrice: 3999, discountedPrice: 1599, badges: ["BEST PRICE EVER!"] },
      { id: "sc-2", name: "Heart & Diabetes Panel", type: "package", includedTests: [{ name: "Lipid Profile", description: "Cholesterol" }, { name: "HbA1c", description: "Blood sugar" }, { name: "Fasting Blood Sugar", description: "Glucose" }, { name: "ECG", description: "Heart rhythm" }], includedTestCount: 4, basePrice: 1999, discountedPrice: 799 },
    ],
  },
  {
    id: "tax-saver",
    ...
    items: [
      { id: "ts-1", name: "Tax Saver Package", type: "package", includedTests: [{ name: "CBC", description: "Blood count" }, { name: "Fasting Blood Sugar", description: "Diabetes" }, { name: "Lipid Profile", description: "Heart" }, { name: "LFT", description: "Liver" }, { name: "KFT", description: "Kidney" }, { name: "TSH", description: "Thyroid" }, { name: "Urine Routine", description: "Urinalysis" }], includedTestCount: 7, basePrice: 1999, discountedPrice: 699, badges: ["BEST PRICE EVER!"] },
      { id: "ts-2", name: "Tax Saver Basic", type: "package", includedTests: [{ name: "CBC", description: "Blood count" }, { name: "Fasting Blood Sugar", description: "Glucose" }, { name: "Lipid Profile", description: "Cholesterol" }, { name: "Urine Routine", description: "Urinalysis" }], includedTestCount: 4, basePrice: 1299, discountedPrice: 499 },
    ],
  },
  {
    id: "fever",
    ...
    items: [
      { id: "fv-1", name: "Fever Panel", type: "package", includedTests: [{ name: "CBC", description: "Blood count" }, { name: "ESR", description: "Inflammation" }, { name: "Malaria Test", description: "Malaria screening" }, { name: "Widal Test", description: "Typhoid screening" }, { name: "CRP", description: "Inflammation marker" }], includedTestCount: 5, basePrice: 1499, discountedPrice: 599 },
      { id: "fv-2", name: "Malaria Test", type: "single", includedTests: [{ name: "Malaria Parasite", description: "Malaria screening" }], includedTestCount: 1, basePrice: 500, discountedPrice: 199 },
      { id: "fv-3", name: "Typhoid Test", type: "single", includedTests: [{ name: "Widal Test", description: "Typhoid screening" }], includedTestCount: 1, basePrice: 500, discountedPrice: 199 },
    ],
  },
  {
    id: "hormone",
    ...
    items: [
      { id: "hm-1", name: "Hormone Panel", type: "package", includedTests: [{ name: "Thyroid Panel", description: "TSH T3 T4" }, { name: "Testosterone", description: "Male hormone" }, { name: "Cortisol", description: "Stress hormone" }, { name: "Insulin Fasting", description: "Insulin" }, { name: "FSH", description: "Reproductive hormone" }, { name: "LH", description: "Reproductive hormone" }, { name: "Prolactin", description: "Pituitary hormone" }], includedTestCount: 7, basePrice: 2999, discountedPrice: 1199, badges: ["BEST PRICE EVER!"] },
      { id: "hm-2", name: "Testosterone Test", type: "single", includedTests: [{ name: "Testosterone", description: "Total testosterone levels" }], includedTestCount: 1, basePrice: 800, discountedPrice: 299 },
      { id: "hm-3", name: "Cortisol Test", type: "single", includedTests: [{ name: "Cortisol", description: "Stress hormone levels" }], includedTestCount: 1, basePrice: 700, discountedPrice: 299 },
    ],
  },
  {
    id: "hairfall",
    ...
    items: [
      { id: "hf-1", name: "Hairfall Panel", type: "package", includedTests: [{ name: "Thyroid Profile", description: "Thyroid" }, { name: "Iron Studies", description: "Iron" }, { name: "Ferritin", description: "Iron stores" }, { name: "Vitamin D", description: "Vitamin" }, { name: "Vitamin B12", description: "B12" }, { name: "Zinc", description: "Mineral" }, { name: "CBC", description: "Blood count" }], includedTestCount: 7, basePrice: 2499, discountedPrice: 999, badges: ["BEST PRICE EVER!"] },
      { id: "hf-2", name: "Vitamin D Test", type: "single", includedTests: [{ name: "Vitamin D", description: "25-OH Vitamin D" }], includedTestCount: 1, basePrice: 1500, discountedPrice: 599 },
      { id: "hf-3", name: "Ferritin Test", type: "single", includedTests: [{ name: "Ferritin", description: "Iron storage protein" }], includedTestCount: 1, basePrice: 800, discountedPrice: 299 },
    ],
  },
  {
    id: "dengue",
    ...
    items: [
      { id: "dg-1", name: "Dengue Panel", type: "package", includedTests: [{ name: "NS1 Antigen", description: "Early dengue detection" }, { name: "IgM Antibody", description: "Recent infection" }, { name: "IgG Antibody", description: "Past exposure" }, { name: "CBC", description: "Blood count" }, { name: "Platelet Count", description: "Platelet monitoring" }], includedTestCount: 5, basePrice: 1999, discountedPrice: 799 },
      { id: "dg-2", name: "Dengue NS1 Antigen", type: "single", includedTests: [{ name: "NS1 Antigen", description: "Early dengue detection" }], includedTestCount: 1, basePrice: 800, discountedPrice: 349 },
      { id: "dg-3", name: "Dengue IgM Test", type: "single", includedTests: [{ name: "Dengue IgM", description: "Recent dengue infection" }], includedTestCount: 1, basePrice: 600, discountedPrice: 249 },
    ],
  },
  {
    id: "bone-joint",
    ...
    items: [
      { id: "bj-1", name: "Bone & Joint Panel", type: "package", includedTests: [{ name: "Calcium", description: "Bone mineral" }, { name: "Vitamin D", description: "Bone health" }, { name: "Phosphorus", description: "Bone mineral" }, { name: "ALP", description: "Bone enzyme" }, { name: "Uric Acid", description: "Gout marker" }, { name: "CRP", description: "Inflammation" }, { name: "ESR", description: "Inflammation" }], includedTestCount: 7, basePrice: 1999, discountedPrice: 799 },
      { id: "bj-2", name: "Rheumatoid Panel", type: "package", includedTests: [{ name: "RF", description: "Rheumatoid factor" }, { name: "CRP", description: "Inflammation" }, { name: "ESR", description: "Inflammation" }, { name: "Anti-CCP", description: "Rheumatoid antibodies" }], includedTestCount: 4, basePrice: 2499, discountedPrice: 999 },
      { id: "bj-3", name: "Uric Acid Test", type: "single", includedTests: [{ name: "Uric Acid", description: "Gout and kidney" }], includedTestCount: 1, basePrice: 500, discountedPrice: 199 },
    ],
  },
  {
    id: "allergy",
    ...
    items: [
      { id: "al-1", name: "Allergy Panel", type: "package", includedTests: [{ name: "Total IgE", description: "Allergy marker" }, { name: "Food Allergy Panel", description: "Common food allergens" }, { name: "CBC with Eosinophil", description: "Blood count" }], includedTestCount: 3, basePrice: 1999, discountedPrice: 799 },
      { id: "al-2", name: "Total IgE Test", type: "single", includedTests: [{ name: "Total IgE", description: "Immunoglobulin E allergy marker" }], includedTestCount: 1, basePrice: 800, discountedPrice: 299 },
    ],
  },
  {
    id: "sexual-wellness",
    ...
    items: [
      { id: "sw-1", name: "STI Screening Panel", type: "package", includedTests: [{ name: "HIV I & II", description: "HIV screening" }, { name: "VDRL", description: "Syphilis screening" }, { name: "Hepatitis B", description: "Hep B screening" }, { name: "Hepatitis C", description: "Hep C screening" }], includedTestCount: 4, basePrice: 2499, discountedPrice: 999, badges: ["BEST PRICE EVER!"] },
      { id: "sw-2", name: "HIV Test", type: "single", includedTests: [{ name: "HIV I & II", description: "HIV screening" }], includedTestCount: 1, basePrice: 800, discountedPrice: 299 },
    ],
  },
  {
    id: "immunity",
    ...
    items: [
      { id: "im-1", name: "Immunity Panel", type: "package", includedTests: [{ name: "CBC", description: "Blood count" }, { name: "IgG", description: "Long-term immunity" }, { name: "IgM", description: "Acute immunity" }, { name: "Vitamin D", description: "Immune regulation" }, { name: "Zinc", description: "Immune mineral" }, { name: "Iron Studies", description: "Iron status" }, { name: "CRP", description: "Inflammation" }], includedTestCount: 7, basePrice: 2499, discountedPrice: 999 },
      { id: "im-2", name: "Immunoglobulin Test", type: "package", includedTests: [{ name: "IgG", description: "Immunoglobulin G" }, { name: "IgM", description: "Immunoglobulin M" }, { name: "IgA", description: "Immunoglobulin A" }], includedTestCount: 3, basePrice: 1499, discountedPrice: 599 },
    ],
  },
  {
    id: "fever-infection",
    ...
    items: [
      { id: "fi-1", name: "Infection Panel", type: "package", includedTests: [{ name: "CBC", description: "Blood count" }, { name: "ESR", description: "Inflammation" }, { name: "CRP", description: "Inflammation" }, { name: "Blood Culture", description: "Bacterial detection" }, { name: "Procalcitonin", description: "Bacterial vs viral" }], includedTestCount: 5, basePrice: 1999, discountedPrice: 799 },
      { id: "fi-2", name: "CRP Test", type: "single", includedTests: [{ name: "CRP", description: "C-reactive protein" }], includedTestCount: 1, basePrice: 500, discountedPrice: 199 },
    ],
  },
  {
    id: "reproductive",
    ...
    items: [
      { id: "rf-1", name: "Female Fertility Panel", type: "package", includedTests: [{ name: "FSH", description: "Ovarian reserve" }, { name: "LH", description: "Ovulation hormone" }, { name: "Estradiol", description: "Estrogen" }, { name: "AMH", description: "Ovarian reserve" }, { name: "Prolactin", description: "Pituitary hormone" }, { name: "Thyroid", description: "Thyroid" }], includedTestCount: 6, basePrice: 2999, discountedPrice: 1199 },
      { id: "rf-2", name: "Male Fertility Panel", type: "package", includedTests: [{ name: "Testosterone", description: "Male hormone" }, { name: "FSH", description: "Spermatogenesis" }, { name: "LH", description: "Pituitary hormone" }, { name: "Prolactin", description: "Pituitary hormone" }], includedTestCount: 4, basePrice: 1999, discountedPrice: 799 },
    ],
  },
  {
    id: "cancer-screening",
    ...
    items: [
      { id: "cs-1", name: "Cancer Screening Panel", type: "package", includedTests: [{ name: "PSA", description: "Prostate marker" }, { name: "CEA", description: "Colon cancer marker" }, { name: "AFP", description: "Liver cancer marker" }, { name: "CA-125", description: "Ovarian cancer marker" }, { name: "CBC", description: "Blood count" }], includedTestCount: 5, basePrice: 3999, discountedPrice: 1599, badges: ["BEST PRICE EVER!"] },
      { id: "cs-2", name: "PSA Test", type: "single", includedTests: [{ name: "PSA", description: "Prostate specific antigen" }], includedTestCount: 1, basePrice: 800, discountedPrice: 299 },
    ],
  },
  {
    id: "hepatitis",
    ...
    items: [
      { id: "hs-1", name: "Hepatitis Panel", type: "package", includedTests: [{ name: "HBsAg", description: "Hepatitis B" }, { name: "Anti-HBc", description: "Hep B core" }, { name: "Anti-HBs", description: "Hep B immunity" }, { name: "Anti-HCV", description: "Hepatitis C" }, { name: "LFT", description: "Liver function" }], includedTestCount: 5, basePrice: 2499, discountedPrice: 999 },
      { id: "hs-2", name: "HBsAg Test", type: "single", includedTests: [{ name: "HBsAg", description: "Hepatitis B surface antigen" }], includedTestCount: 1, basePrice: 600, discountedPrice: 249 },
    ],
  },
  {
    id: "lungs",
    ...
    items: [
      { id: "lu-1", name: "Lung Health Panel", type: "package", includedTests: [{ name: "CBC", description: "Blood count" }, { name: "ESR", description: "Inflammation" }, { name: "CRP", description: "Inflammation" }, { name: "Sputum Culture", description: "Infection detection" }], includedTestCount: 4, basePrice: 1499, discountedPrice: 599 },
      { id: "lu-2", name: "CRP Test", type: "single", includedTests: [{ name: "CRP", description: "C-reactive protein" }], includedTestCount: 1, basePrice: 500, discountedPrice: 199 },
    ],
  },
  {
    id: "weight",
    ...
    items: [
      { id: "wm-1", name: "Weight Management Panel", type: "package", includedTests: [{ name: "Thyroid Profile", description: "Thyroid" }, { name: "Fasting Insulin", description: "Insulin resistance" }, { name: "HbA1c", description: "Blood sugar" }, { name: "Cortisol", description: "Stress hormone" }, { name: "Lipid Profile", description: "Cholesterol" }, { name: "Vitamin D", description: "Metabolic health" }], includedTestCount: 6, basePrice: 2499, discountedPrice: 999, badges: ["BEST PRICE EVER!"] },
      { id: "wm-2", name: "Thyroid Test", type: "single", includedTests: [{ name: "TSH", description: "Thyroid stimulating hormone" }], includedTestCount: 1, basePrice: 500, discountedPrice: 199 },
    ],
  },
  {
    id: "iron",
    ...
    items: [
      { id: "is-1", name: "Iron Studies Panel", type: "package", includedTests: [{ name: "Serum Iron", description: "Blood iron" }, { name: "Ferritin", description: "Iron stores" }, { name: "TIBC", description: "Iron binding capacity" }, { name: "Transferrin Saturation", description: "Iron saturation" }, { name: "CBC", description: "Blood count" }], includedTestCount: 5, basePrice: 1499, discountedPrice: 599 },
      { id: "is-2", name: "Ferritin Test", type: "single", includedTests: [{ name: "Ferritin", description: "Iron storage protein" }], includedTestCount: 1, basePrice: 800, discountedPrice: 299 },
    ],
  },
  {
    id: "covid",
    ...
    items: [
      { id: "cv-1", name: "COVID-19 RT-PCR", type: "single", includedTests: [{ name: "RT-PCR", description: "Molecular COVID-19 test" }], includedTestCount: 1, basePrice: 1200, discountedPrice: 499 },
      { id: "cv-2", name: "COVID Antibody Panel", type: "package", includedTests: [{ name: "IgG Antibody", description: "Past infection immunity" }, { name: "IgM Antibody", description: "Recent infection" }], includedTestCount: 2, basePrice: 1499, discountedPrice: 599 },
              ...
              <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                {filteredItems.map((item) => {
                  ...
                  return (
                    <div
                      key={item.id}
                      className="flex flex-col rounded-xl border border-gray-200 bg-white p-3 transition-all hover:shadow-md hover:border-gray-300"
                    >
                      ...
                      {item.promotionalText && (
                        <p className="mb-2 text-[11px] font-semibold text-[#0a3d2e]">{item.promotionalText}</p>
                      )}
          ...
          <div className="w-full max-w-lg rounded-2xl bg-white shadow-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="sticky bottom-0 bg-white border-t border-gray-100 px-6 py-4 rounded-b-2xl">
              <button onClick={handleBookingSubmit} className="w-full rounded-xl bg-[#0a3d2e] py-3.5 text-sm font-bold text-white hover:bg-[#082f23] transition-colors flex items-center justify-center gap-2">
                <Calendar className="size-4" />Confirm Booking — ₹{(bookingTest.discountedPrice != null && bookingTest.discountedPrice > 0 && bookingTest.discountedPrice < bookingTest.basePrice ? bookingTest.discountedPrice : bookingTest.basePrice).toLocaleString("en-IN")}
              </button>
            </div>
          </div>
        </div>
