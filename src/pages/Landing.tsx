        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 py-6 sm:py-8">
          <div className="flex flex-wrap items-center gap-3 -ml-4 sm:-ml-6">
            ...
            <button
              ...
              className="inline-flex flex-1 items-center gap-2.5 rounded-lg border border-border/60 bg-card hover:bg-accent/40 px-3 py-2.5 sm:px-4 sm:py-3 transition-all duration-300 group cursor-pointer shadow-sm hover:shadow-md"
            >
