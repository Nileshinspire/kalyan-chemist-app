  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-hidden">
      ...
      <section className="bg-background">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 py-6 sm:py-8">
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-5">
            ...
            >
              <div className="flex size-7 shrink-0 items-center justify-center rounded-lg bg-primary/10 text-primary group-hover:bg-primary/15 transition-colors">
            ...
            >
              ...
              <div className="text-left">
                ...
                <p className="text-[10px] sm:text-[11px] font-semibold uppercase tracking-wider text-primary/70 mt-0.5">
                  Book Now
                </p>
              </div>
            </button>
      ...
      {/* Uses the shared footer system so every route shows the same
          navigation, contact details, policies and trust information. */}
      <Footer />
