...
export const PREDEFINED_LAB_TESTS: PredefinedCategory[] = [
  ...
  },
  {
    ...
    tests: [
      ...
      { name: "Urine Routine Examination", description: "Detects urinary tract infections common in women." },
    ],
  },
  {
    slug: "senior-citizen",
    ...
    tests: [
      ...
      { name: "Thyroid Profile (TSH, T3, T4)", description: "Thyroid disorders are common in the elderly." },
      ...
      { name: "Urine Routine Examination", description: "Detects UTIs and kidney issues common in the elderly." },
    ],
  },
  {
    slug: "tax-saver",
    ...
    tests: [
      ...
      { name: "Thyroid Profile (TSH, T3, T4)", description: "Thyroid screening." },
      { name: "Urine Routine Examination", description: "General urine analysis." },
    ],
  },
  {
    slug: "fever",
    ...
    tests: [
      ...
      { name: "Malaria Parasite Test", description: "Detects malaria parasites in the blood." },
  ...
  },
  {
    ...
    tests: [
      ...
      { name: "Ferritin", description: "Low ferritin is the most sensitive early marker of iron deficiency causing hair loss." },
  ...
  },
  {
    ...
    tests: [
      ...
      { name: "CRP (C-Reactive Protein)", description: "Detects acute inflammation in joints and systemic autoimmune conditions." },
    ],
  },
  {
    slug: "allergy",
  ...
  },
  {
    ...
    tests: [
      ...
      { name: "ESR (Erythrocyte Sedimentation Rate)", description: "Non-specific marker of infection and inflammation." },
  ...
  },
  {
    ...
    tests: [
      ...
      { name: "Thyroid Profile (TSH, T3, T4)", description: "Thyroid disorders can significantly affect fertility." },
  ...
  },
  {
    ...
    tests: [
      ...
      { name: "ESR (Erythrocyte Sedimentation Rate)", description: "Non-specific marker of lung inflammation." },
      { name: "CRP (C-Reactive Protein)", description: "Detects acute respiratory infection and inflammation." },
    ],
  },
  {
    slug: "weight",
  ...
  },
  {
    ...
    tests: [
      ...
      { name: "Fasting Blood Sugar (FBS)", description: "Screens for diabetes by measuring fasting glucose." },
      { name: "HbA1c (Glycated Haemoglobin)", description: "Shows average blood glucose over the past 2–3 months." },
      { name: "Lipid Profile", description: "Cardiovascular risk assessment." },
      { name: "Liver Function Test (LFT)", description: "Liver health evaluation." },
      { name: "Kidney Function Test (KFT)", description: "Kidney health assessment." },
      { name: "Thyroid Profile (TSH, T3, T4)", description: "Thyroid function screening." },
      ...
      { name: "Urine Routine Examination", description: "General urine health screening." },
    ],
  },
];
